...
/**
 * This file contains product-specific images for important featured products
 * Separated from main imageUtils.ts for better organization
 */

// Product-specific image mappings for popular products
export const productSpecificImages: Record<number, string[]> = {
  ...
  11: [
    ...
    "https://images.unsplash.com/photo-1593642634524-b40b5b5f2911?q=80&w=1600&auto=format&fit=crop"
  ]
};
